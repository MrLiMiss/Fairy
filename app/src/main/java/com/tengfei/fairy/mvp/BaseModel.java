...
//                }else if(Constants.Code.CUSTOMER_ADD_LS_DIFFRIENT_MANAGER.equals(body.code)){
//                    responseCallBack.onSuccess(body.code,body.data);
//
//                } else if (Config.Code.DYNAMICKEY_TIME_OUT.equals(body.code)) {
